...
// const fetcher = await fetch(fetchUrl, fetchOptions).then((response) =>
//   response.json()
// );

// try {
//   const fetcher = (fetchUrl, fetchOptions) =>
//     fetch(fetchUrl, fetchOptions).then((res) => res.json());
//   const { data } = useSWR([fetchUrl, fetchOptions], fetcher);
